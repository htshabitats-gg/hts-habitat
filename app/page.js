...
// ── SVG Monogram ──
function HHMonogram({ size = 44, animated = false }: { size?: number; animated?: boolean }) {
...
// ── Counter animation ──
function useCounter(target: number, suffix: string, decimals = 0) {
...
export default function HomePage() {
  ...
  const [lightbox, setLightbox] = useState({ open: false, images: [] as string[], index: 0 });
